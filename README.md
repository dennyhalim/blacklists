...
| `compact1` | `etblock` + `feodo` + `toxic` + `dshield7` + `abuseipdb7` | 1,732 | [TXT](dist/plain/compact1.txt) | [RSC](dist/mikrotik/compact1.rsc) | [NFT](dist/nftables/compact1.nft) / [SH](dist/nftables/compact1.sh) | [SH](dist/ipset/compact1.sh) | [PS1](dist/windows/compact1.ps1) / [BAT](dist/windows/compact1.bat) | [TXT](dist/pf/compact1.txt) / [SH](dist/pf/compact1.sh) |
| `compact2` | `etblock` + `feodo` + `dshield7` + `abuseipdb7` | 1,674 | [TXT](dist/plain/compact2.txt) | [RSC](dist/mikrotik/compact2.rsc) | [NFT](dist/nftables/compact2.nft) / [SH](dist/nftables/compact2.sh) | [SH](dist/ipset/compact2.sh) | [PS1](dist/windows/compact2.ps1) / [BAT](dist/windows/compact2.bat) | [TXT](dist/pf/compact2.txt) / [SH](dist/pf/compact2.sh) |
