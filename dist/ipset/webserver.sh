...
ipset add "$SET_NAME" 45.148.10.12 -exist
ipset add "$SET_NAME" 45.148.10.40 -exist
ipset add "$SET_NAME" 45.148.10.42 -exist
ipset add "$SET_NAME" 45.148.10.201 -exist
ipset add "$SET_NAME" 45.148.10.246/31 -exist
...
ipset add "$SET_NAME" 146.185.223.0/24 -exist
...
ipset add "$SET_NAME" 195.178.110.72 -exist
ipset add "$SET_NAME" 195.178.110.101 -exist
ipset add "$SET_NAME" 195.178.110.102/31 -exist
...
ipset add "$SET_NAME" 213.209.159.84 -exist
